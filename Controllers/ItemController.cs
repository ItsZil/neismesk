...
namespace neismesk.Controllers
{
    ...
    public class ItemController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetItem(int itemId)
        {
            try
            {
                var item_data = await _database.LoadData(
                ...
                {
                    string questionText = item_data.Rows[0]["question_text"].ToString();
                ...
                if (item_data.Rows.Count > 0)
                {
                    string imageBlob = item_data.Rows[0]["image_blob"].ToString();
                ...
                var result = (from DataRow dt in item_data.Rows
                              group dt by new
                              {
                                  Id = Convert.ToInt32(dt["id"]),
                                  Name = dt["name"].ToString(),
                              ...
                              select new ItemViewModel()
                              {
                                  ...
                                  Questions = (from DataRow questionRow in item_data.Rows
